...
{
public:
    LgHvac() : PollingComponent(4000) {}
    void set_reference_temperature(esphome::sensor::Sensor *reference_temperature)
    {
    ...
    void setup() override
    {
        ...
        while (this->available())
        {
            ...
            this->read_array(input_buffer, 1);
        }
    }
    ...
    void update() override
    {
        ...
        while (this->available())
        {
            ...
            this->read_array(input_buffer, 6);
